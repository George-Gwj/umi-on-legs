...
# kps = [56.8180+10,  56.6650+10,  51.0831+10,  73.0741+10,  65.1575+10,  45.9261+10,  40.9404,
#         59.3790,  46.9374,  42.8220,  39.4459,  49.8876, 223.6642, 212.9659,
#         53.2537,  74.9537,  56.0480,  15.1038] + 10*np.ones(18)
...
def play():
    ...
    xml_path_ = "/home/george/code/umi-on-legs/mani-centric-wbc/resources/robots/aliengo_description/urdf/scene.xml"
